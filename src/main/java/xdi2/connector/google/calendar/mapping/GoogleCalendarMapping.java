...
public class GoogleCalendarMapping {
	...
	public String calendarXriToCalendarIdentifier(XDI3Segment calendarXri) {
		...
		String calendarIdentifier = (calendarXri.getNumSubSegments() < 2) ? null : XdiAbstractContext.getBaseArcXri(calendarXri.getSubSegment(1)).toString();
	...
	public String eventXriToEventIdentifier(XDI3Segment eventXri) {
		...
		String eventIdentifier = (eventXri.getNumSubSegments() < 2) ? null : XdiAbstractContext.getBaseArcXri(eventXri.getSubSegment(1)).toString();
